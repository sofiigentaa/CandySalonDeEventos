    ...
    <div className="bg-white rounded-2xl border border-slate-200/80 p-3 mb-4 shadow-xs space-y-2.5">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-xs bg-slate-50/80 hover:bg-slate-100/70 focus:bg-white border border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 transition-all"
          />
          {searchTerm && (
            <button
        ...
        <div className="flex items-center gap-2 justify-between sm:justify-end">
          ...
          {onOpenNewEvent && (
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-bold text-white bg-pink-600 hover:bg-pink-700 active:scale-95 rounded-xl shadow-xs transition-all cursor-pointer whitespace-nowrap"
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-[11px] no-scrollbar">
        <button
          ...
          className={`flex items-center gap-1.5 px-2.5 py-1 rounded-xl font-semibold whitespace-nowrap transition-all ${
            statusFilter === 'all'
